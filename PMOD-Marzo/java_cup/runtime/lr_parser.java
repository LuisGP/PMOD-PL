...
public abstract class lr_parser {
  ...
  public void debug_shift(Symbol shift_tkn)
    {
      debug_message("# Shift under term #" + shift_tkn.toString() + 
  ...
  public Symbol debug_parse()
    throws java.lang.Exception
    {
      ...
      debug_message("# Current Symbol is #" + cur_token.toString());
	  ...
	  if (act > 0)
	    {
	      ...
	      /* advance to the next Symbol */
	      cur_token = scan();
              debug_message("# Current token is " + cur_token + " value: " + cur_token.value);
	    }
	  /* if its less than zero, then it encodes a reduce action */
	  else if (act < 0)
	    {
  ...
  protected boolean error_recovery(boolean debug)
      ...
      for (;;)
	{
	  ...
	  if (debug) 
	      debug_message("# Consuming Symbol #" + lookahead[ 0 ].toString());
	  restart_lookahead();
	}
	  ...
	  if (act > 0)
	    {
	      ...
	      if (debug) debug_message("# Parse-ahead shifts Symbol #" + 
		       cur_err_token().toString() + " into state #" + (act-1));
  ...
  protected void parse_lookahead(boolean debug)
      ...
      if (debug) 
	{
	  ...
	  debug_message("# Current Symbol is #" + cur_err_token().toString());
